/*COMPLEXITY*/
/*For study time complexity of this algorithm we observe that we have a loop repeted N times and the cost of an iterate operation is related to the operations below.
